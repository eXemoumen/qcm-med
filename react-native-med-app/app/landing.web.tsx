...
const FEATURES = [
  {
    ...
    desc: "Une base de données massive classée par module et par année pour une révision ciblée.",
    color: "#09b2ac",
    bg: "rgba(9,178,172,0.2)",
  },
  {
    icon: CloudOff,
...
const SELLING_POINTS = [
  {
    emoji: "📚",
    name: "مكتبة The Best Print",
    city: "CONSTANTINE",
    desc: "مقابل مدخل جامعة قسنطينة 3",
    link: "https://maps.app.goo.gl/QyXXSVMnx8nUfXmv5",
    color: "#09b2ac",
  },
  {
    emoji: "📚",
    name: "مكتبة الواحة",
    city: "CONSTANTINE",
    desc: "علي منجلي - إقامة الياسمين وج15",
    link: "https://maps.app.goo.gl/74pCVT3WK9LEaacp7",
    color: "#9840fe",
  },
  {
    emoji: "📱",
    name: "Hero Phone",
    city: "CONSTANTINE",
    desc: "علي منجلي - بالقرب من محطة الاستقلال",
    link: "https://maps.app.goo.gl/DSubQHw7Sbe4kUeY7",
    color: "#09b2ac",
  },
  {
    emoji: "📚",
    name: "مكتبة نوميديا",
    city: "BISKRA",
    desc: "بسكرة - مقابل مدخل الجامعة",
    link: "https://maps.app.goo.gl/7xDqRrwTm2TNRUtH6",
    color: "#e98556",
  },
  {
    emoji: "🏪",
    name: "Khirou KMS",
    city: "OUM EL BOUAGHI",
    desc: "أم البواقي - مقابل مدخل الملحقة",
    link: "https://goo.gl/maps/RrcPeibFArYGPWi98",
    color: "#09b2ac",
  },
  {
    emoji: "🏠",
    name: "Foyer",
    city: "KHENCHELA",
    desc: "خنشلة - جامعة عباس لغرور",
    link: "https://goo.gl/maps/33UHDZhf95412CjA9",
    color: "#7e17e4",
  },
  {
    emoji: "📚",
    name: "مكتبة الأمان",
    city: "SOUK AHRAS",
    desc: "سوق أهراس - وسط المدينة",
    link: "https://maps.app.goo.gl/kcb6RSTcSxJoSYH98",
    color: "#09b2ac",
  },
];
...
const AnimatedStat = ({ stat }: { stat: (typeof STATS)[0] }) => {
  ...
  const display =
    stat.staticVal ||
    (val >= 1000 ? (val / 1000).toFixed(val >= 1000 ? 0 : 1) + "K" : val);
...
export default function LandingWeb() {
  ...
  return (
    <div className="min-h-screen bg-[#fff9ef] text-[#1d1b16] font-['Cairo'] overflow-x-hidden">
      ...
      {/* Navigation Shell */}
      <nav
        className={`fixed top-4 left-1/2 -translate-x-1/2 w-[95%] max-w-7xl rounded-full border z-50 transition-all duration-300 flex justify-between items-center px-8 py-3 ${
          isDarkSection
      ...
      >
        ...
        <div className="hidden md:flex gap-8 items-center">
          <a
            className={`font-['Manrope'] font-bold text-sm tracking-wide hover:text-[#9941ff] transition-colors duration-300 ${isDarkSection ? "text-white" : "text-slate-700"}`}
            href="#features"
          >
            Fonctionnalités
          </a>
          ...
          <button
            onClick={goOutils}
            className={`bg-transparent border-0 p-0 cursor-pointer font-['Manrope'] font-bold text-sm tracking-wide hover:text-[#9941ff] transition-colors duration-300 ${isDarkSection ? "text-white" : "text-slate-700"}`}
          >
            Calcul
          </button>
        </div>
        ...
        <div className="hidden md:flex items-center gap-4">
          <button
            onClick={goAuth}
            className={`font-['Manrope'] font-bold text-sm tracking-wide hover:text-[#9941ff] transition-colors duration-300 ${isDarkSection ? "text-white" : "text-[#09b2ac]"}`}
          >
            Se connecter
          </button>
          <button
            onClick={goAuth}
            className="bg-[#09b2ac] text-white font-['Manrope'] font-bold text-sm px-6 py-2.5 rounded-full hover:scale-95 transition-all shadow-lg shadow-[#09b2ac]/20 hover:bg-[#0d9488]"
          >
            Créer un compte
          </button>
        </div>
        ...
        <button
          className={`md:hidden p-2 transition-colors duration-300 ${isDarkSection ? "text-white" : "text-[#1d1b16]"}`}
          ...
          >
            <div className="flex flex-col gap-4">
              <a
                ...
                className="font-['Manrope'] text-lg font-bold text-slate-800"
              >
                Fonctionnalités
              </a>
              <a
              ...
              <button
                ...
                className="bg-transparent border-0 p-0 cursor-pointer text-left font-['Manrope'] text-lg font-bold text-slate-800"
              >
                Calcul
              </button>
            </div>
            <div className="flex flex-col gap-3 pt-4 border-t border-slate-100">
              <button
                onClick={goAuth}
                className="w-full py-3 rounded-xl border border-slate-200 text-[#09b2ac] font-bold font-['Manrope']"
              >
                Se connecter
              </button>
              <button
                onClick={goAuth}
                className="w-full py-3 rounded-xl bg-[#09b2ac] text-white font-bold font-['Manrope'] shadow-lg shadow-[#09b2ac]/20"
              >
                Créer un compte
              </button>
            </div>
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto w-full text-center mt-10">
          ...
          >
            ...
            <motion.h1
              variants={fadeIn}
              className="font-['Manrope'] font-extrabold text-5xl md:text-7xl lg:text-8xl leading-[1.1] mb-6 tracking-tight text-[#1d1b16]"
            >
              Medical study <br className="hidden md:block" />
              <span className="text-[#09b2ac]">reinvented</span>
            </motion.h1>

            {/* Subtitle */}
            <motion.p
              variants={fadeIn}
              className="text-lg md:text-2xl text-slate-600 max-w-2xl mx-auto mb-12 leading-relaxed"
            >
              The ultimate MCQ bank for medical students of Constantine.
            </motion.p>

            {/* CTAs */}
            <motion.div
              variants={fadeIn}
              className="flex flex-col sm:flex-row sm:flex-wrap items-center justify-center gap-6 mb-24"
            >
              <button
                onClick={goAuth}
                className="w-full sm:w-auto bg-[#006a66] text-white font-['Manrope'] font-bold text-lg px-10 py-5 rounded-[3rem] flex items-center justify-center gap-2 hover:bg-[#00504d] transition-all shadow-xl shadow-[#006a66]/20"
              >
                Créer un compte
                <ArrowRight size={20} />
              </button>
              <button
                onClick={goAuth}
                className="w-full sm:w-auto border-2 border-[#09b2ac]/30 text-[#09b2ac] font-['Manrope'] font-bold text-lg px-10 py-5 rounded-[3rem] hover:bg-[#09b2ac]/5 transition-all"
              >
                Se connecter
              </button>
              <button
                onClick={goOutils}
                className="w-full sm:w-auto border-2 border-[#9941ff]/25 text-[#2a0054] bg-white font-['Manrope'] font-bold text-lg px-10 py-5 rounded-[3rem] flex items-center justify-center gap-2 hover:bg-[#f8f0ff] transition-all shadow-lg shadow-[#9941ff]/10"
              >
                <Calculator size={20} />
                Calcul
              </button>
          ...
          >
            <div className="relative bg-white p-8 md:p-10 rounded-[2rem] md:rounded-[3rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] border border-slate-100 text-left max-w-2xl mx-auto">
              <div className="flex justify-between items-center mb-6">
                <span className="px-4 py-1.5 bg-[#eedcff] text-[#2a0054] rounded-full text-xs font-bold font-['Manrope']">
                  Sémiologie
                </span>
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-8 font-['Manrope'] leading-snug text-[#1d1b16]">
                Parmi les manifestations cliniques d'une anémie on note:
              </h3>
              <div className="space-y-4">
                <div className="p-4 md:p-5 rounded-2xl bg-[#09b2ac]/10 border-2 border-[#09b2ac] flex items-center justify-between shadow-lg shadow-[#09b2ac]/10 relative">
                  <div className="flex items-center gap-4">
                    <span className="w-8 h-8 rounded-full bg-[#006a66] text-white text-sm flex items-center justify-center font-bold">
                      A
                    </span>
                    <p className="text-sm md:text-base font-bold text-[#006a66]">
                      Pâleur cutanée et muqueuse
                    </p>
                  </div>
                  <CheckCircle2
                    size={24}
                    className="text-[#006a66] absolute right-5"
                  />
                </div>
                <div className="p-4 md:p-5 rounded-2xl bg-[#09b2ac]/10 border-2 border-[#09b2ac] flex items-center justify-between shadow-lg shadow-[#09b2ac]/10 relative">
                  <div className="flex items-center gap-4">
                ...
                <div className="p-4 md:p-5 rounded-2xl bg-[#f9f3e9] border border-slate-200 flex items-center gap-4">
                  <span className="w-8 h-8 rounded-full border border-[#006a66] text-[#006a66] text-sm flex items-center justify-center font-bold">
                    D
                  </span>
            ...
            >
              <div className="relative w-16 h-16">
                ...
                <span className="absolute inset-0 flex items-center justify-center font-['Manrope'] font-extrabold text-xs md:text-sm text-[#006a66]">
                  78%
                </span>
              </div>
              <div className="text-left">
                <p className="text-[10px] md:text-xs font-['Manrope'] font-bold text-slate-500 uppercase tracking-widest mb-1">
                  Progression
                </p>
                <p className="text-base md:text-lg font-bold text-[#1d1b16] leading-tight">
                  Sémiologie
                </p>
              </div>
            </motion.div>
      ...
      <section
        id="features"
        className="bg-[#262626] text-white pt-40 pb-32 px-6 mt-32 rounded-t-[4rem]"
      >
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="max-w-2xl">
              <span className="text-[#09b2ac] font-['Manrope'] font-bold uppercase tracking-[0.2em] text-sm block mb-4">
                Fonctionnalités
              </span>
            ...
            {FEATURES.map((feat, i) => {
              ...
              return (
                <motion.div
                  key={i}
                  variants={fadeIn}
                  className={`glass-card p-10 rounded-2xl hover:bg-white/5 transition-all group border border-white/5 ${isWide ? "md:col-span-2 flex flex-col md:flex-row gap-10 items-center" : ""}`}
                >
                  <div className={isWide ? "flex-1" : ""}>
                    ...
                    <h3 className="text-2xl font-bold mb-4 font-['Manrope'] text-white">
                      {feat.title}
                    </h3>
                    <p className="text-slate-400 leading-relaxed font-['Cairo']">
                      {feat.desc}
                    </p>
                  </div>
                  ...
                  {isWide && (
                    <div className="flex-1 w-full bg-black/20 p-6 rounded-2xl border border-white/5">
                      <div className="flex justify-between items-center mb-4">
                        ...
                        <span className="text-[#09b2ac] font-bold">
                          14.5/20
                        </span>
                      </div>
                      <div className="h-2 w-full bg-white/5 rounded-full overflow-hidden mb-6">
                        <motion.div
                          ...
                          className="h-full bg-[#09b2ac] rounded-full"
                        ></motion.div>
                      </div>
                      <div className="space-y-4">
      ...
      <section
        id="points"
        className="py-32 px-6 bg-[#262626] border-t border-white/5"
      >
        <div className="max-w-7xl mx-auto">
          <motion.div
            initial="hidden"
          ...
          >
            <span className="text-[#9941ff] font-['Manrope'] font-bold uppercase tracking-[0.2em] text-sm block mb-4">
              Disponibilité
            </span>
          ...
          >
            {SELLING_POINTS.map((point, i) => (
              <motion.div
                key={i}
                variants={fadeIn}
                className="bg-white/5 p-8 rounded-2xl border border-white/10 text-right group hover:bg-white/10 hover:-translate-y-1 transition-all"
              >
                <div className="flex justify-between items-start mb-6">
                  {point.link && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center text-slate-400 hover:text-white hover:bg-[#09b2ac] transition-all"
                    >
                      <MapPin size={22} />
                    </a>
                  )}
                  <div className="flex flex-col items-end gap-2">
                    <span
                      className="px-3 py-1 rounded-full text-xs font-bold font-['Manrope']"
                      style={{
                        color: point.color,
                ...
                <p className="text-slate-400 text-sm mb-6 font-['Cairo']">
                  {point.desc}
                </p>
                <div
                  className="flex items-center justify-end gap-2 lowercase"
                  style={{ color: point.color }}
                >
                  <span className="text-xs font-bold uppercase tracking-widest text-[#09b2ac]">
                    Disponible
                  </span>
        ...
        <div className="max-w-7xl mx-auto px-8 md:px-12 w-full grid grid-cols-1 md:grid-cols-4 gap-12 text-slate-600">
          <div className="flex flex-col gap-6 md:pr-8">
            <div className="flex items-center gap-3">
              ...
              />
              <span className="text-2xl font-extrabold text-[#1d1b16] font-['Manrope'] tracking-tight">
                FMC App
              </span>
            </div>
          ...
          <div className="flex flex-col gap-6">
            <h4 className="text-slate-400 font-extrabold text-[11px] uppercase tracking-widest">
              Liens Rapides
            </h4>
            <nav className="flex flex-col gap-4 font-['Cairo'] text-[15px]">
              <a
                className="hover:text-[#006a66] transition-colors"
                href="#features"
              >
                Fonctionnalités
              </a>
              <a className="hover:text-[#006a66] transition-colors" href="#">
                Comment ça marche
              </a>
              <a
                className="hover:text-[#006a66] transition-colors"
          ...
          <div className="flex flex-col gap-6">
            ...
            <nav className="flex flex-col gap-4 font-['Cairo'] text-[15px]">
              ...
              <a
                ...
                rel="noreferrer"
              >
                <Smartphone size={18} className="text-slate-400" /> Google Play
                Store
              </a>
            </nav>
          </div>
        ...
        {loading ? (
          ...
          <div className={`grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10`}>
            {[1, 2].map((i) => (
              <div
                key={i}
                className="bg-white/5 p-10 md:p-12 rounded-3xl border border-white/5 animate-pulse"
              >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            variants={staggerContainer}
            className="grid grid-cols-1 max-w-lg mx-auto gap-8"
          >
            <motion.div
              variants={fadeIn}
              className="bg-white/5 p-10 md:p-12 rounded-3xl border-2 border-[#09b2ac] shadow-[0_0_40px_rgba(9,178,172,0.15)] relative overflow-hidden group"
            >
              <div className="absolute top-6 right-0 bg-[#09b2ac] text-white px-8 py-2 font-bold text-xs tracking-widest uppercase">
                Populaire
              </div>
              ...
              <p className="text-slate-400 mb-8 text-sm">
                Contactez-nous pour les tarifs actuels.
              </p>
              <button
                onClick={goAuth}
                className="w-full py-4 rounded-xl bg-[#09b2ac] text-white font-bold font-['Manrope'] hover:shadow-lg hover:bg-[#0d9488] hover:shadow-[#09b2ac]/30 transition-all relative z-10"
              >
          ...
          >
            {plans.map((plan) => {
              const features = plan.is_featured
                ? PLAN_FEATURES_FEATURED
              ...
              return (
                ...
                >
                  ...
                  <p className="text-slate-400 mb-8 text-sm">
                    {plan.description ||
                      `Accès pendant ${formatDuration(plan.duration_days)}`}
                  </p>

                  {/* Price */}
                  <div
                    className={`flex items-baseline gap-2 mb-8 ${plan.is_featured ? "relative z-10" : ""}`}
                  >
                  ...
                  {/* Features */}
                  <ul
                    className={`space-y-5 mb-10 ${plan.is_featured ? "relative z-10" : ""}`}
                  >
                    {features.map((feature, i) => (
                      <li
                        key={i}
                        className={`flex items-start gap-4 text-slate-300 ${plan.is_featured && i === 0 ? "font-bold" : ""}`}
                      >
                        <CheckCircle2
                          className="text-[#09b2ac] flex-shrink-0"
                          size={20}
                        />
                  ...
                  {plan.is_featured ? (
                    ...
                    <button
                      onClick={goAuth}
                      className="w-full py-4 rounded-xl border border-[#09b2ac]/50 text-[#09b2ac] font-bold font-['Manrope'] hover:bg-[#09b2ac] hover:text-white transition-all"
                    >
                      Choisir cette offre
                    </button>
                  )}
